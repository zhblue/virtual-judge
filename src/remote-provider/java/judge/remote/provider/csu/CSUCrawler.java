...
public class CSUCrawler extends SimpleCrawler {
    ...
    protected void populateProblemInfo(RawProblemInfo info, String problemId, String html) {
        ...
        info.timeLimit = (1000 * Integer.parseInt(Tools.regFind(html, "Time Limit: </span><span.*?>(\\d+) Sec")));
        info.memoryLimit = (1024 * Integer.parseInt(Tools.regFind(html, "Memory Limit: </span><span.*?>(\\d+) MB")));
